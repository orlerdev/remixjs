...
function QuoteCard() {
  ...
  const [quote, setQuote] = (0, import_react3.useState)(quotes[random].quoteText);
  const [author, setAuthor] = (0, import_react3.useState)(quotes[random].quoteAuthor);
  function randomQuote() {
    setQuote(quotes[random].quoteText);
    setAuthor(quotes[random].quoteAuthor);
...
//# sourceMappingURL=/build/routes/index-M7VWRL6H.js.map
